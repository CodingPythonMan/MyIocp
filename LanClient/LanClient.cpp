...
bool LanClient::Start(WCHAR IP[], int Port, int WorkerThreadCount, bool Nagle, int MaxUserCount)
{
	int retval;
...
int LanClient::GetSessionCount()
{
	return _SessionCount;
}

void LanClient::RecvPost(SessionID sessionID)
{
...
void LanClient::SendPost(SessionID sessionID)
{
	Session* session = FindSession(sessionID);
...
bool LanClient::Disconnect(SessionID sessionID)
{
	Session* session = FindSession(sessionID);
...
bool LanClient::SendPacket(SessionID sessionID, Packet& packet)
{
	Session* session = FindSession(sessionID);
...
int LanClient::GetAcceptTPS()
{
	return _AcceptTPS;
}

int LanClient::GetRecvMessageTPS()
{
	return _RecvMessageTPS;
}

int LanClient::GetSendMessageTPS()
{
	return _SendMessageTPS;
}

Session* LanClient::FindSession(SessionID sessionID)
{
	unsigned short index = ConvertIndex(sessionID);
...
unsigned short LanClient::ConvertIndex(SessionID sessionID)
{
	return sessionID >> 48;
}

unsigned int WINAPI LanClient::AcceptThread(LPVOID lpParam)
{
	LanClient* server = (LanClient*)lpParam;
...
unsigned int WINAPI LanClient::CalTPSThread(LPVOID lpParam)
{
	LanClient* server = (LanClient*)lpParam;
